...
func NewUserAuthMiddleware(acntRepository domain.AccountRepository) userAuth {
	return userAuth{acntRepository: acntRepository}
}

func (uAuth *userAuth) GetInstance() *jwt.HertzJWTMiddleware {
	authMiddleware, err := jwt.New(&jwt.HertzJWTMiddleware{
		...
		Authenticator: func(ctx context.Context, c *app.RequestContext) (interface{}, error) {
			...
			acnt, err := uAuth.acntRepository.Get(email)
			if err != nil {
